...
### 2026-06-03 (batch 1 of new-items push)
Three tax-heavy items added in one go — each tells a "you don't realise how much is tax" story.

- **Tank of petrol** *(category: consumer)* — Representative £70 fill-up at £1.40/L. Top level: fuel duty 38% → income-tax (xref), VAT 17% → income-tax, wholesale fuel 38%, retailer margin 7%. Wholesale fuel drills into crude oil (with country-of-origin sub-breakdown: Middle East 25%, Norway 20%, US shale 18%, UKCS 12%, Africa 10%, other 15%), refining, distribution, wholesale margin. Retailer margin drills into forecourt operations and where the operator profit goes (EG Group / Issa brothers + TDR Capital story). The headline reveal: ~55% of every litre is tax.
- **A pint of beer** *(category: consumer)* — Representative £5 pint of mainstream lager. Top level: VAT 17% → income-tax, beer duty 10% → income-tax (using the 2023-reform draught rate of 19.08p/L × ABV), wholesale beer cost 30%, pub operations 43%. Two editorial stories: (a) Big UK beer brands all owned by foreign multinationals — Carling/Coors (Molson Coors, US/Canada), Foster's UK/Heineken (Heineken, Netherlands), Stella/Bud (AB InBev, Belgium/Brazil), Carlsberg (Denmark) — drills into brewer operating profit and ultimate-shareholder destinations; (b) the tied-pub story — most UK pubs lease from a pubco (Stonegate, Greene King, Punch) and must buy beer at marked-up wholesale, so the rent line captures meaningful pubco extraction. Heineken N.V. CEO Dolf van den Brink ~£4.9m used as representative brewer-CEO pay (~198× NMW).
- **A pack of cigarettes** *(category: consumer)* — The most extreme tax-share figure in the app at ~77%. Tobacco duty 60% → income-tax (specific £6.33/pack + 16.5% ad valorem), VAT 17% → income-tax, retailer margin 7%, tobacco manufacturer 16%. Drills into Big Tobacco operating profit (BAT plc + Imperial Brands are FTSE 100; JTI and PMI complete the big four with ~95% UK market share), where the profit goes to UK corp tax, very high dividends widely held by UK pension funds, buybacks, next-gen product capex (Vuse, Glo, IQOS), and BAT CEO Tadeu Marroco's ~£3.5m pay (~141× NMW).

All three new trees have 100% source coverage and clean share sums. BUNDLED_DATA stubs updated. Pill restructure deferred to end of new-items push.
